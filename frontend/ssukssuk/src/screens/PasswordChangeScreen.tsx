...
const CARD_BG = "#fafaf6"; // 입력창 내부 배경색
        ...
        <SafeAreaView style={styles.safe}>
            ...
            >
                ...
                >
                    ...
                    <Text style={[styles.label, { marginTop: 18 }]}>새로운 비밀번호 확인</Text>
                    <PixelInput
                        value={newPwConfirm}
...
function PixelBox({ children, style }: any) {
    return (
        <View style={[styles.pixelBoxContainer, style]}>
            ...
            {/* 2) 내부 음영 레이어 (기둥 공백 해결) */}
            <View pointerEvents="none" style={[styles.shadeLeft, { left: -PIXEL_SIZE, width: PIXEL_SIZE, top: 0, bottom: 0 }]} />
            <View pointerEvents="none" style={[styles.shadeRight, { right: -PIXEL_SIZE, width: PIXEL_SIZE, top: 0, bottom: 0 }]} />

            <View pointerEvents="none" style={[styles.shadeLeft, {
                left: -PIXEL_SIZE,
                top: PIXEL_SIZE,
                bottom: PIXEL_SIZE,
                opacity: 0.03,
            ...
            <View pointerEvents="none" style={[styles.shadeRight, {
                right: -PIXEL_SIZE,
                top: PIXEL_SIZE,
                bottom: PIXEL_SIZE,
                opacity: 0.03,
...
const styles = StyleSheet.create({
    ...
    pixelBgUnderlay: { position: "absolute", top: 0, bottom: 0, left: -PIXEL_SIZE, right: -PIXEL_SIZE, backgroundColor: CARD_BG, zIndex: 0 },
    cardInner: { paddingHorizontal: 15, height: 54, justifyContent: 'center', zIndex: 10 },

    shadeLeft: { position: "absolute", backgroundColor: "#000", opacity: 0.05, zIndex: 1 },
    shadeRight: { position: "absolute", backgroundColor: "#000", opacity: 0.05, zIndex: 1 },
    ...
    bottomBar: { paddingHorizontal: 26, paddingBottom: 44, backgroundColor: "#EDEDE9" },
