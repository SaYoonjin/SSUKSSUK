...
<!-- 홈 화면 스크린샷 -->
<p align="center"><img src="docs/images/home_screen.jpg" width="300" alt="SSUKSSUK 홈 화면" /></p>
...
## 🧩 My Role (Backend Focus)

본 프로젝트에서 저는 **Java 기반 백엔드 서버 개발**을 중심으로 담당했습니다.

### 주요 담당 영역

- Spring Boot 기반 REST API 설계 및 구현
- MQTT 메시지 수신 처리 및 이벤트 기반 로직 구현
- MySQL 데이터 모델링 및 JPA 기반 데이터 처리
- Redis 캐시 적용을 통한 성능 최적화
- Firebase Push Notification 서버 연동
- Docker 기반 서버 컨테이너 구성
